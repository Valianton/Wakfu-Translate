...
$InstallButton.Add_Click({
    ...
    Write-Host "Обновление ключа реестра"
    (Update-RegKey 'version' $NewVersion)
    Write-Host "Обновление заголовков формы"
    $window_form.Text = "ВАКФУ Русификатор v$NewVersion"
    $InfoLabel.Text = "Русификатор успешно установлен"
    Write-Host "Русификатор успешно обновлен до версии $NewVersion"
})
